...
def send_email(image):
    recipient_email = "iammunibmir@gmail.com"  # Recipient email address
    ...
    sender_email = "munibsmotiondetector@gmail.com"  # Sender email address
    password = "tfwpusgndjdapldu"  # Sender email password
